...
[Contributors][sample-algorithm-contributors-url]
[Forks][sample-algorithm-forks-url]
[Stargazers][sample-algorithm-stars-url]
[Issues][sample-algorithm-issues-url]
[License][sample-algorithm-license-url]
...
1. Adriana Sofia Rozo Cepeda Cod. 202211498 ([as.rozo@uniandes.edu.co](mailto:as.rozo@uniandes.edu.co))
2. Diego Fernando Galván Cruz Cod.  202213709 ([d.galvanc@uniandes.edu.co](mailto:d.galvanc@uniandes.edu.co))
3. Juan David Castillo Quiroga Cod. 202210669. ([j.castilloq@uniandes.edu.co](mailto:j.castilloq@uniandes.edu.co))
...
2. [App](./App) Folder with the Model-View-Controller (MVC) Python scripts. In here the students implement their code to complete the laboratory instructions.
3. [Data](./Data) Folder with CSV data files to load into the application. In here the students add the data files provided by the course staff to complete the laboratory.
4. [Docs](./Docs) Folder with the report, data table and other documentation. In here the students add their project report, data tables and other files to complement their code implementation.
