...
def searchPaths(analyzer, initialStation, method="dfs"):
    ...
    return model.searchPaths(analyzer, initialStation, method)
...
def hasSearchPath(analyzer, destStation, method="dfs"):
    ...
    return model.hasSearchPath(analyzer, destStation, method)
...
def searchPathTo(analyzer, destStation, method="dfs"):
    ...
    return model.searchPathTo(analyzer, destStation, method)
